...
kg/cityfilter/0.0.3/citylist
kg/cityfilter/0.0.3/index
 ...
 * 
 */
KISSY.add('kg/cityfilter/0.0.3/citylist',function (S, Node) {
 ...
 * @module cityfilter
 **/
KISSY.add('kg/cityfilter/0.0.3/index',function (S, Node, Base, Citylist) {
    var EMPTY = '';
    var $ = Node.all;
